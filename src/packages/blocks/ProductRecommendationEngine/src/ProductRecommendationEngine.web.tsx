...
import ProductRecommendationEngineController, {
  Props,
  configJSON,
} from "./ProductRecommendationEngineController";

export default class ProductRecommendationEngine extends ProductRecommendationEngineController {
