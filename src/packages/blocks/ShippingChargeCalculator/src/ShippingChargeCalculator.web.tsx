...
import ShippingChargeCalculatorController, {
  Props,
  configJSON,
} from "./ShippingChargeCalculatorController";

export default class ShippingChargeCalculator extends ShippingChargeCalculatorController {
